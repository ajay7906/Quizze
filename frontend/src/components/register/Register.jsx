...
//         }
//         else if (isLogin && errorMessage.email) {
...
//         }
//         else if (isLogin &&  errorMessage.password) {
//             errors.email = errorMessage.password;
//         }
...
//                             value={formData.email}
//                             onChange={handleInputChange}
//                             className={`${styles.input} ${isLogin ? loginErrors.email : registerErrors.email ? styles.errorInput : ''}`}
...
//                             value={formData.password}
//                             onChange={handleInputChange}
//                             className={`${styles.input} ${isLogin ? loginErrors.password : registerErrors.password ? styles.errorInput : ''}`}
