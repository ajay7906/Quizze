...
//       {/* Sidebar */}
//       <aside 
//         className={`fixed lg:relative w-72 bg-white p-6 shadow-lg flex flex-col justify-between h-screen border-r border-gray-200 z-50 transform transition-transform duration-300 ease-in-out
