  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (isMobileMenuOpen && 
          ...
          !event.target.closest('.lg\\:hidden.fixed.top-4.right-4')) {
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <h2 className="font-jomhuria text-5xl text-gray-800">EXAM</h2>
                {/* <div className="w-12 h-1 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full ml-2"></div> */}
              </div>
            </div>
            ...
            <div className="hidden lg:flex lg:items-center lg:justify-center lg:flex-1 lg:px-8">
              <div className="flex space-x-2">
                <NavLink 
                  to={role === 'student' ? '/student' : '/'} 
                  className={({ isActive }) => 
                    `flex items-center px-4 py-2 rounded-xl transition-all duration-200 font-medium text-base
                    ${isActive 
                      ? 'bg-gradient-to-r from-purple-100 to-indigo-100 text-purple-700 shadow-md border border-purple-200' 
                      : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800'}`
                  }
            ...
            <div className="hidden lg:flex lg:items-center">
              <button 
                onClick={handleLogout}
                className="flex items-center px-4 py-2 text-gray-700 font-semibold rounded-xl hover:bg-gray-100 transition-all duration-200 hover:text-red-600"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
          ...
          <div className="lg:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <NavLink 
                to={role === 'student' ? '/student' : '/'} 
                className={({ isActive }) => 
                  `flex items-center px-3 py-3 rounded-xl transition-all duration-200 font-medium text-base
                  ${isActive 
                    ? 'bg-gradient-to-r from-purple-100 to-indigo-100 text-purple-700 shadow-md border border-purple-200' 
                    : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800'}`
                }
              ...
              <button 
                onClick={handleLogout}
                className="flex items-center w-full px-3 py-3 text-gray-700 font-semibold rounded-xl hover:bg-gray-100 transition-all duration-200 hover:text-red-600 mt-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
