...
//       const data = await response.json();
//       if (data.success) {
//         // Navigate to practice session with quiz data
...
//         <p>Choose your subject and topic to start practicing with AI-generated questions</p>
//       </div>
...
//                       selectedDifficulty === diff.value ? styles.active : ''
//                     }`}
